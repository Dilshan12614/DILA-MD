...
const port = process.env.PORT || 8000;
  ...
  conn.ev.on('messages.upsert', async(mek) => {
	  // index.js ඇතුලත මැසේජ් එක කියවන කොටසට මේක දාන්න
...
// මැසේජ් එකේ තියෙන අකුරු කියවා ගැනීම (.highway Command එක තියෙනවද බැලීම)
...
if (body === '.highway') {
    ...
    // 2. හරියටම ඔයා එවපු ස්ක්‍රීන්ෂොට් එක වගේ ඩොකියුමන්ට් එකක් විදිහට යැවීම
    await conn.sendMessage(jid, { 
        document: Buffer.from(""), // 💡 සටහන: මෙතනට ඔයාගේ ඇත්තම ෆයිල් එකේ දත්ත (Buffer) දෙන්න
